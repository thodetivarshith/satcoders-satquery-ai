...
def maybe_zero_3(param, ignore_status=False, name=None):
    # Single-GPU/T4 setup: no DeepSpeed ZeRO-3 is used.
...
def get_peft_state_non_lora_maybe_zero_3(named_params, require_grad_only=True):
    ...
    if require_grad_only:
        to_return = {
            k: t for k, t in to_return.items()
            if t.requires_grad or "mm_projector" in k
        }
    to_return = {
...
def train():
    ...
    if training_args.lora_enable:
        ...
        # Force final LoRA checkpoint save for single-GPU Kaggle/T4.
        os.makedirs(training_args.output_dir, exist_ok=True)

        print("Saving final LoRA checkpoint...")
