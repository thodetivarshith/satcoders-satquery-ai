...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    ...
    if 'geochat' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            # T4/high-resolution compatibility:
            # The fine-tuning checkpoint contains a 1297-position
            # CLIP positional embedding. The base GeoChat model
            # initializes with 577 positions.
            #
            # Do not load this saved positional tensor.
            # The patched CLIP implementation interpolates the
            # base 577-position embedding to the required size.
            position_key = (
                "model.vision_tower.vision_tower."
                "vision_model.embeddings.position_embedding.weight"
            )

            if position_key in non_lora_trainables:
                saved_shape = non_lora_trainables[position_key].shape
                print(
                    "Skipping saved CLIP positional embedding:",
                    saved_shape
                )
...
model.load_state_dict(non_lora_trainables, strict=False)
            ...
            print('Keeping LoRA adapter attached for inference...')

            # Do NOT merge LoRA into the quantized base model.
            # PEFT 0.4 blocks merge_and_unload() for quantized models.
            # The PeftModel can perform inference directly with the
